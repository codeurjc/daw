...
public class DatabaseInitializer {
	...
	public void init() throws IOException, URISyntaxException {
		...
		Book book1 = new Book("SUEÑOS DE ACERO Y NEON",
				...
				new ArrayList<>(Arrays.asList(shop2, shop3)));
		...
		bookService.createBook(new Book("CASI SIN QUERER",
		...
		bookService.createBook(new Book("TERMINAMOS Y OTROS POEMAS SIN TERMINAR",
		...
		bookService.createBook(new Book("LA LEGIÓN PERDIDA",
				...
				new ArrayList<>(Arrays.asList(shop1, shop3))));

		// Sample users

		userService.createUser(new User("user", passwordEncoder.encode("pass"), "USER"));
		userService.createUser(new User("admin", passwordEncoder.encode("adminpass"), "USER", "ADMIN"));
	}
